        ...
        <table width="600" cellspacing="0" cellpadding="0" style="background-color: whitesmoke;">
            ...
            <tr>
                <td style="padding:20px 20px;">
                    ...
                    <p>We're thrilled to inform you that your subscription has been successfully renewed.</p>
                    <p>Here are some details about your renewal:</p>
                    <table class="subtable">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                <div><strong>Amount Charged:</strong> <?php echo Wo_GetCurrency($wo['config']['currency']);?>[AmountCharged]</div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <p>You can view the details of this renewal and access your invoice by clicking the link below:</p>
                    <p><a href="[InvoiceLink]" class="targetBtn" style="color: #fff;" target="_blank">View Invoice</a></p>
                </td>
            </tr>
            </tbody>
        </table>
