<div class="sidebar-conatnier">
        ...
        <div class="home profile-style main sidebar-profile-style">
            <div class="card hovercard">
                <div class="cardheader">
                    <img src="http://localhost:81/wowonder/upload/photos/d-cover.jpg?cache=0" id="cover-image" alt="Simon Templar Cover Image">
                </div>
                <div class="avatar">
                    <img id="updateImage-2" alt="Simon Templar Profile Picture" src="http://localhost:81/wowonder/upload/photos/d-avatar.jpg?cache=0" >
                </div>
                <div class="info">
                    <div class="title">
                        <a id="user-full-name" data-ajax="?link1=timeline&u=gpfcore" href="http://localhost:81/wowonder/gpfcore">Simon Templar</a>
                        						<p>@gpfcore</p>
                    </div>
                </div>
				...
				<ul class="wo_user_side_info">
					<li>
						<a class="menu_list" href="http://localhost:81/wowonder/gpfcore" data-ajax="?link1=timeline&u=gpfcore">
							...
							<span id="user_post_count">0</span>
										...
										<li>
						<a class="menu_list" href="http://localhost:81/wowonder/gpfcore/following" data-ajax="?link1=timeline&u=gpfcore&type=following">
							<span class="split-link"><b>Following</b></span>
							<span>1</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="http://localhost:81/wowonder/gpfcore/followers" data-ajax="?link1=timeline&u=gpfcore&type=followers">
		   ...
		   <!-- <div class="featured-users">
			<ul class="list-group" style="margin-bottom: 0;background: transparent;box-shadow: none !important;">
									<li class="pro-me-here pull-right"><a href="http://localhost:81/wowonder/go-pro">Put Me Here</a></li>
	...
	<div class="user">
		...
		<a href="http://localhost:81/wowonder/Natalie" data-ajax="?link1=timeline&u=Natalie">
			<img alt="Natalie Kaklugin" src="http://localhost:81/wowonder/upload/photos/d-avatar.jpg?cache=0" />
			<span title="Natalie Kaklugin">Natalie Kaklugin</span>
		</a>
	</div>
</li> 			</ul>
		</div> -->
	...
	<div class="avatar">
		<img src="http://localhost:81/wowonder/upload/photos/d-avatar.jpg?cache=0" alt="Joanna Bushell Profile Picture"/>
	</div>
     <span class="user-popover" data-id="124" data-type="user">
		<a href="http://localhost:81/wowonder/Jobushell" data-ajax="?link1=timeline&u=Jobushell" class="wo_user_link_name">
			<span class="user-name" title="Joanna Bushell">Joanna Bushell</span>
		</a>
        <div class="text-center">
		<span class="label label-danger">Nurse</span>
	</div>
    </span>
    ...
    <div class="user-follow-btn">
        <div class="user-follow-button">
            <span id="Follow-124">
    <button type="button" onclick="Wo_RegisterFollow(124, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
	...
	<div class="avatar">
		<img src="http://localhost:81/wowonder/upload/photos/d-avatar.jpg?cache=0" alt="Natalie Kaklugin Profile Picture"/>
	</div>
     <span class="user-popover" data-id="193" data-type="user">
		<a href="http://localhost:81/wowonder/Natalie" data-ajax="?link1=timeline&u=Natalie" class="wo_user_link_name">
			<span class="user-name" title="Natalie Kaklugin">Natalie Kaklugin</span>
		</a>
        <div class="text-center">
		<span class="label label-danger">Pharmacist</span>
	</div>
    </span>
	<div class="wo_user_username_cont">
	</div>
    <div class="user-follow-btn">
        <div class="user-follow-button">
            <span id="Follow-193">
    <button type="button" onclick="Wo_RegisterFollow(193, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
       <span class="button-text"> Follow</span>
    </button>
</span>        </div>
	...
	<div class="avatar">
		<img src="http://localhost:81/wowonder/upload/photos/d-avatar.jpg?cache=0" alt="Badriah alkhatib Profile Picture"/>
	</div>
     <span class="user-popover" data-id="136" data-type="user">
		<a href="http://localhost:81/wowonder/ba25dr" data-ajax="?link1=timeline&u=ba25dr" class="wo_user_link_name">
			<span class="user-name" title="Badriah alkhatib">Badriah alkhatib</span>
		</a>
        <div class="text-center">
		<span class="label label-danger">GP Trainee</span>
	</div>
    </span>
	<div class="wo_user_username_cont">
	</div>
    <div class="user-follow-btn">
        <div class="user-follow-button">
            <span id="Follow-136">
    <button type="button" onclick="Wo_RegisterFollow(136, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
       <span class="button-text"> Follow</span>
    </button>
</span>        </div>
	...
	<div class="avatar">
		<img src="http://localhost:81/wowonder/upload/photos/d-avatar.jpg?cache=0" alt="Saagar Shastri Profile Picture"/>
	</div>
     <span class="user-popover" data-id="133" data-type="user">
		<a href="http://localhost:81/wowonder/saagar1" data-ajax="?link1=timeline&u=saagar1" class="wo_user_link_name">
			<span class="user-name" title="Saagar Shastri">Saagar Shastri</span>
		</a>
        <div class="text-center">
		<span class="label label-danger">GP</span>
	</div>
    </span>
	<div class="wo_user_username_cont">
	</div>
    <div class="user-follow-btn">
        <div class="user-follow-button">
            <span id="Follow-133">
    <button type="button" onclick="Wo_RegisterFollow(133, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
       <span class="button-text"> Follow</span>
    </button>
</span>        </div>
            ...
            <li class="list-group-item text-muted sidebar-title-back" contenteditable="false">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: #e91e63;"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg> Suggested groups <span onclick="Wo_ReloadSideBarGroups();" class="pull-right  refresh">
                <i class="fa fa-repeat progress-icon" data-icon="repeat"></i>
                </span>
            </li>
            <li>
                <div class="sidebar-group-may-know-container">
                    <div class="home-sidebar profile-style wo_sidebar_groups">
    <div class="avatar pull-left">
            <img src="http://localhost:81/wowonder/upload/photos/d-group.jpg " alt="BARDOC Profile Picture" />
     </div>
     <span class="user-popover" data-id="33" data-type="group">
    <a href="http://localhost:81/wowonder/BARDOC" data-ajax="?link1=timeline&u=BARDOC">
    ...
    <div class="user-lastseen">
        ...
        <div class="user-follow-button">
            <span id="join-33">
    <button type="button" onclick="Wo_RegisterGroupJoin(33, 1)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
       <span class="button-text"> Join</span>
    </button>
</span>        </div>
</div><div class="home-sidebar profile-style wo_sidebar_groups">
    <div class="avatar pull-left">
            <img src="http://localhost:81/wowonder/upload/photos/d-group.jpg " alt="CSA Group Profile Picture" />
     </div>
     <span class="user-popover" data-id="35" data-type="group">
    <a href="http://localhost:81/wowonder/CSAGroup" data-ajax="?link1=timeline&u=CSAGroup">
        <span class="user-name">
            CSA Group        </span>
    </a>
    </span>
    <div class="user-lastseen">
        ...
        <div class="user-follow-button">
            <span id="join-35">
    <button type="button" onclick="Wo_RegisterGroupJoin(35, 1)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
       <span class="button-text"> Join</span>
    </button>
</span>        </div>
    ...
    <div class="avatar pull-left">
            <img src="http://localhost:81/wowonder/upload/photos/d-group.jpg " alt="Pharma Profile Picture" />
     </div>
     <span class="user-popover" data-id="31" data-type="group">
    <a href="http://localhost:81/wowonder/Pharma" data-ajax="?link1=timeline&u=Pharma">
        <span class="user-name">
            Pharma        </span>
    </a>
    </span>
    <div class="user-lastseen">
        ...
        <div class="user-follow-button">
            <span id="join-31">
    <button type="button" onclick="Wo_RegisterGroupJoin(31, 1)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
       <span class="button-text"> Join</span>
    </button>
</span>        </div>
                ...
                <div class="clear"></div>
                        ...
                        <ul class="list-group">
                        <li class="list-group-item sidebar-title-back" contenteditable="false"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: #2196F3;"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg> Online Users 1</li>
            <li>
                <div class="clear"></div>
            </li>
        </ul>
                <ul class="list-group">
            <li class="list-group-item sidebar-title-back" contenteditable="false"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: #795548;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg> Invite Your Colleagues</li>
            <li>
                <form action="#" method="post" class="row invite-user-form">
                    ...
                    <button class="btn btn-main btn-sm" title="Send Invitation">
	...
	<div class="footer-wrapper sidebar">
		...
		<ul class="list-inline pull-left">
			...
			<li><a data-ajax="?link1=terms&type=about-us" href="http://localhost:81/wowonder/terms/about-us">About</a></li>

			
				<li><a href="http://localhost:81/wowonder/blogs">Blog</a></li>

			
			<li><a data-ajax="?link1=contact-us" href="http://localhost:81/wowonder/contact-us">Contact Us</a></li>
			...
			<li>
				...
				<div class="dropdown dropup">
					...
					<ul class="dropdown-menu" role="menu" style="width: auto; min-width: 100px; font-size: 11px;">
						...
						<li><a data-ajax="?link1=terms&type=privacy-policy" href="http://localhost:81/wowonder/terms/privacy-policy">Privacy Policy</a></li>

						<li><a data-ajax="?link1=terms&type=terms" href="http://localhost:81/wowonder/terms/terms">Terms of Use</a></li>
  ...
  if ("geolocation" in navigator) {
   ...
   navigator.permissions && navigator.permissions.query({name: 'geolocation'}).then(function(PermissionStatus) {
        if(PermissionStatus.state == 'granted'){
             ...
             $('.wow_weather_icon').html('Please enable location on your browser to view current weather.')
        }
    })
